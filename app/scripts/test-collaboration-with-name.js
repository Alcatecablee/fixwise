// Test collaboration system with user_name field
...
async function testCollaborationWithName() {
  try {
    console.log('🧪 Testing collaboration system with user_name...\n');
    ...
    const { data: teamData, error: teamError } = await supabase
      .from('teams')
      .insert({
        name: 'Test Team with Name',
        description: 'Testing with user_name field',
        owner_id: userId
      })
      .select()
      .single();
    ...
    if (sessionError) {
      ...
      // Test 4: Session participant addition with user_name
      console.log('\n[INFO] Test 4: Session participant addition with user_name...');
      ...
      if (participantError) {
        ...
        console.log('[SUCCESS] Session participant added with user_name');
      }
    }
